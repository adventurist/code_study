...
TARGET = obj/$(CONFIG).$(PLATFORM)$(COMPILER_SUFFIX)$(DEBUG_SUFFIX)/ColorSpheres$(OUT)
...
PRJ_CFLAGS += \
	 -g $(FPIC) -DREPOSITORY_VERSION="\"$(REPOSITORY_VER)\"" \
			 -D_DEBUG
...
$(OBJ)colorSpheres.sym: colorSpheres.ec
	$(ECP) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) -c $(call quote_path,colorSpheres.ec) -o $(call quote_path,$@)

# C OBJECT RULES

$(OBJ)colorSpheres.c: colorSpheres.ec $(OBJ)colorSpheres.sym | $(SYMBOLS)
	$(ECC) $(CFLAGS) $(CECFLAGS) $(ECFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,colorSpheres.ec) -o $(call quote_path,$@) -symbols $(OBJ)

# OBJECT RULES

$(OBJ)colorSpheres$(O): $(OBJ)colorSpheres.c
	$(CC) $(CFLAGS) $(PRJ_CFLAGS) $(FVISIBILITY) -c $(call quote_path,$(OBJ)colorSpheres.c) -o $(call quote_path,$@)
